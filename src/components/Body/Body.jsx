...
<div className="blocks-container">
  ...
  <div className="block-3">
    ...
    <div id='h2'>
      <p>Построить карьеру проще если умеещь работать с нейросетями!</p>
    </div>


    <div className="black-block-1">
      <img id="ico"src="plus.png" alt=""  />
      <h1>Построить карьеру проще если умеещь работать с нейросетями!</h1>
      <p>Согласно исследованию «Русской школы управления», 52% компаний учитывают владение инструментами искусственного интеллекта при найме сотрудников.</p>
    </div>
    </div>
